 ...
 *  moment of creation of the signal. It shoud be a time of measurement for
 ...
 *  provides means, to treat another data types as well. Namely boolean type
 *  and an array of real numbers (a vector). Value property is immutable.
 *
 */
