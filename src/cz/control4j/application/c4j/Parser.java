...
class Parser
{
  ...
  public static int parseScope2(String scope)
  {
    ...
    throw new CommonException()
        ...
        .set("message",
            String.format("Scope attribute may be: %s | %s",
            GLOBAL_SCOPE_STRING, LOCAL_SCOPE_STRING))
        .set("scope", scope);
  }
  ...
  public static int parseScope3(String scope)
  {
    ...
    throw new CommonException()
        .setCode(ExceptionCode.PARSE)
        .set("message",
            String.format("Scope attribute may contain these values: %s | %s | %s",
                GLOBAL_SCOPE_STRING, LOCAL_SCOPE_STRING, PARENT_SCOPE_STRING))
        .set("scope", scope);
  }
